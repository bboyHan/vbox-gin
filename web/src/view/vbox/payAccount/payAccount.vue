    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="操作">
          <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="showVPAInfo(scope.row)">对接
            </el-button>
            <el-button type="primary" link icon="edit" class="table-button" @click="updatePayAccountFunc(scope.row)">
              变更
            </el-button>
