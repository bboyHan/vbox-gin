    ...
    <div v-show="payVisible">
      ...
      <div v-if="payTypeVisible >= 8000 && payTypeVisible < 8099">
        <div class="p_container">
          ...
          <div style="width: 100%; padding: 20px 20px; color: aliceblue;">
            <div style="display: flex; justify-content: space-between; font-size:16px ;gap:6px">
                  <p style="font-size: 16px;">待支付: 50元</p>
                  <p style="font-size: 16px;">剩余: 9分19秒</p>
            </div>
          </div>
          <div class="p_content" :style="backgroundImageStyle">
            <el-row >
              ...
              <el-col>
                <p style="text-align: left; font-size: 16px" >订单号 TEST170427200242878
                </p>
              </el-col>
            </el-row>
          </div>
          <div class="p_content" style="top: 110px;">
            <el-row>
              <el-col>
                <div >
        ...
        <div class="p_content_button_8000">
          ...
          <button class="btn-copy p_button_pay" @click="openYdVisible">立即支付</button>
        </div>
      </div>
