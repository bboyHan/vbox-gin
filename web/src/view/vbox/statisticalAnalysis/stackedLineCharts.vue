...
const orderView = async () => {
  // let resData = await getBdaChaccIndexToDayIncome({uid : props.uid})
  // console.log('lineCharts resData:', resData)
