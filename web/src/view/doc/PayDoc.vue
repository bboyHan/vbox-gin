<template>
  ...
  <div class='typora-export-content'>
    <div id='write' class=''><h3 id='0-对接信息'><span>0. 对接信息</span></h3>
      <li><p><span>请求地址： 联系对接人获取</span></p></li>
      <li><p><span>回调IP白名单： 联系对接人获取</span></p></li>
      <h3 id='1-公共签名规则'><strong><span>1.</span></strong><span> </span><strong><span>公共签名规则</span></strong>
      </h3>
      <ol start=''>
        <li><p><span>联系运营获取商户ID、商户Key</span></p></li>
        <li><p><span>签名sign计算：请求参数按照ASCII 码的升序进行排序，按照key=value&amp;key=value进行组合，最后加上商户秘钥（&amp;key=商户秘钥）,进行md5运算,结果转为小写</span>
        </p></li>
      </ol>
      <h3 id='21-创建订单'><strong><span>2.1</span></strong><span> </span><strong><span>创建订单</span></strong></h3>
      <p><span>请求参数（request）</span></p>
      <figure class='table-figure'>
        <table>
          <thead>
          <tr>
            <th><span>字段名</span></th>
            <th><strong><span>字段描述</span></strong></th>
            <th><strong><span>类型</span></strong></th>
            <th><strong><span>必需</span></strong></th>
            <th><span>说明事项</span></th>
          </tr>
          </thead>
          <tbody>
          <tr>
          ...
          <tr>
            ...
            <td><span>int</span></td>
            <td><span>是</span></td>
            <td><span>单位：元</span></td>
          </tr>
          <tr>
            <td><span>order_id</span></td>
            <td><span>订单ID</span></td>
            <td><span>string[16,32]</span></td>
            <td><span>是</span></td>
            <td><span>商户自定义订单ID（支持16-32位不定长uuid）</span></td>
          </tr>
          <tr>
            <td><span>channel_code</span></td>
            <td><span>通道编码</span></td>
            <td><span>string</span></td>
            <td><span>是</span></td>
            <td><span>联系接口人获取</span></td>
          </tr>
          <tr>
            <td><span>notify_url</span></td>
            <td><span>回调地址</span></td>
            <td><span>string</span></td>
            <td><span>是</span></td>
          ...
          <tr>
            ...
            <td><span>string</span></td>
            <td><span>是</span></td>
            <td><span>参见1.1 公共签名规则</span></td>
          </tr>
          </tbody>
        </table>
      </figure>
      <p><span>请求方式</span></p>
      <pre class="md-fences md-end-block ty-contain-cm modeLoaded" spellcheck="false" lang=""><div
          class="CodeMirror cm-s-inner cm-s-null-scroll CodeMirror-wrap" lang=""><div
          style="overflow: hidden; position: relative; width: 3px; height: 0; top: 9.26172px; left: 8px;"><textarea
      ...
      <pre class="md-fences md-end-block ty-contain-cm modeLoaded" spellcheck="false" lang=""><div
          class="CodeMirror cm-s-inner cm-s-null-scroll CodeMirror-wrap" lang=""><div
          style="overflow: hidden; position: relative; width: 3px; height: 0px; top: 9.52344px; left: 8px;"><textarea
          autocorrect="off" autocapitalize="off" spellcheck="false" tabindex="0"
          style="position: absolute; bottom: -1em; padding: 0px; width: 1000px; height: 1em; outline: none;"></textarea></div><div
          class="CodeMirror-scrollbar-filler" cm-not-content="true"></div><div class="CodeMirror-gutter-filler"
                                                                               cm-not-content="true"></div><div
          ...
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp;  "code": 0,</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp;  "data": {</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp; &nbsp; &nbsp;  "order_id": "订单ID",</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp; &nbsp; &nbsp;  "pay_url": "支付地址",</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp; &nbsp; &nbsp;  "notify_url": "回调地址",</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp; &nbsp; &nbsp;  "money": 10,</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp; &nbsp; &nbsp;  "status": 2</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp;  },</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp;  "msg": "创建成功"</span></pre><pre
          ...
          style="position: absolute; height: 0px; width: 1px; border-bottom: 0px solid transparent; top: 254px;"></div><div
          class="CodeMirror-gutters" style="display: none; height: 254px;"></div></div></div></pre>
      <p><span>回调说明</span></p>
      <pre class="md-fences md-end-block ty-contain-cm modeLoaded" spellcheck="false" lang=""><div
          class="CodeMirror cm-s-inner cm-s-null-scroll CodeMirror-wrap" lang=""><div
          style="overflow: hidden; position: relative; width: 3px; height: 0px; top: 9.52344px; left: 8px;"><textarea
          ...
          class="CodeMirror-activeline-background CodeMirror-linebackground"></div><div
          class="CodeMirror-gutter-background CodeMirror-activeline-gutter" style="left: 0px; width: 0px;"></div><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"># 订单完成支付后,下单接口里面的异步通知地址（notify_url）会收到服务器点对点通知，消息体如下：</span></pre></div><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">{</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp;  "order_id": "订单ID",</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp;  "pay_url": "支付地址",</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp;  "money": 10,</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp;  "notify_url": "回调地址",</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp;  "status": 1,</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp;  "sign": "签名",</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">}</span></pre><pre
          ...
          cm-text="" cm-zwsp="">
                                                                             ...
                                                                             style="padding-right: 0.1px;">status: 0-失败,1-成功,2-未支付</span></pre><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"># 注意：收到我方回调通知后,请返回HTTP Status状态码200，否则我方将按一定频率重复通知若干次</span></pre></div></div></div></div></div><div
          style="position: absolute; height: 0px; width: 1px; border-bottom: 0px solid transparent; top: 277px;"></div><div
          class="CodeMirror-gutters" style="display: none; height: 277px;"></div></div></div></pre>
      <h3 id='22-查询订单'><strong><span>2.2</span></strong><span> </span><strong><span>查询订单</span></strong></h3>
      <p><span>请求参数（request）</span></p>
      <figure class='table-figure'>
        <table>
          <thead>
      ...
      <p><span>响应结果</span></p>
      <pre class="md-fences md-end-block ty-contain-cm" spellcheck="false" lang="shell"><div
          ...
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">{</span></pre></div><pre
          class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"> &nbsp; &nbsp;<span
          class="cm-string">"code"</span>: <span class="cm-number">0</span>,</span></pre><pre class=" CodeMirror-line "
                                                                                              role="presentation"><span
          role="presentation" style="padding-right: 0.1px;"> &nbsp; &nbsp;<span
          class="cm-string">"data"</span>: {</span></pre><pre class=" CodeMirror-line " role="presentation"><span
          role="presentation" style="padding-right: 0.1px;"> &nbsp; &nbsp; &nbsp; &nbsp;<span class="cm-string">"order_id"</span>: <span
          class="cm-string">"订单ID"</span>,</span></pre><pre class=" CodeMirror-line " role="presentation"><span
          role="presentation" style="padding-right: 0.1px;"> &nbsp; &nbsp; &nbsp; &nbsp;<span class="cm-string">"pay_url"</span>: <span
          class="cm-string">"支付地址"</span>,</span></pre><pre class=" CodeMirror-line " role="presentation"><span
          role="presentation" style="padding-right: 0.1px;"> &nbsp; &nbsp; &nbsp; &nbsp;<span class="cm-string">"notify_url"</span>: <span
          class="cm-string">"回调地址"</span>,</span></pre><pre class=" CodeMirror-line " role="presentation"><span
          role="presentation" style="padding-right: 0.1px;"> &nbsp; &nbsp; &nbsp; &nbsp;<span
          class="cm-string">"money"</span>: <span class="cm-number">1</span>,</span></pre><pre class=" CodeMirror-line "
                                                                                               role="presentation"><span
          role="presentation" style="padding-right: 0.1px;"> &nbsp; &nbsp; &nbsp; &nbsp;<span
          class="cm-string">"status"</span>: <span class="cm-number">1</span></span></pre><pre class=" CodeMirror-line "
                                                                                               role="presentation"><span
          role="presentation" style="padding-right: 0.1px;"> &nbsp;  },</span></pre><pre class=" CodeMirror-line "
                                                                                         role="presentation"><span
          role="presentation" style="padding-right: 0.1px;"> &nbsp; &nbsp;<span class="cm-string">"msg"</span>: <span
          class="cm-string">"查询成功"</span></span></pre><pre class=" CodeMirror-line " role="presentation"><span
