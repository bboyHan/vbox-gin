...
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /bdaChaccIndexD/getBdaChaccIndexDUesrOverview [get]
export const getBdaChaccIndexToDayIncome = (params) => {
  return service({
    url: '/bdaChaccIndexD/getBdaChaccIndexToDayIncome',
    method: 'get',
    params
  })
}
...
export const getBdaChaccIndexToDayInOkCnt = (params) => {
  return service({
    url: '/bdaChaccIndexD/getBdaChaccIndexToDayInOkCnt',
    method: 'get',
    params
  })
}
...
export const getBdaChaccIndexToWeekIncome = (params) => {
  return service({
    url: '/bdaChaccIndexD/getBdaChaccIndexToWeekIncome',
    method: 'get',
    params
  })
}
...
export const getBdaChaccIndexToWeekInOkCnt = (params) => {
  return service({
    url: '/bdaChaccIndexD/getBdaChaccIndexToWeekInOkCnt',
    method: 'get',
    params
  })
}
