...
export const getBdaChorgIndexRealList = (params) => {
  return service({
    url: '/bdaChorg/getBdaChorgIndexRealList',
    method: 'get',
    params
  })
}
...
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /bdaChorg/getBdaChorgIndexRealList [get]
export const getBdaChorgIndexRealListBySelect = (params) => {
  return service({
    url: '/bdaChorg/getBdaChorgIndexRealListBySelect',
    method: 'get',
    params
  })
}
