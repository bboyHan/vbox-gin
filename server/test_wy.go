...
//
//	un := "https://service.mkey.163.com/mpay/games/aecgauwcm4aaaap3-g-x11/devices/amawksaaassellt2-d/users/aebgkokbbv6nzf7i/ecard_recharge?token=1-eyJzIjogIjgzMGRkYmVmMjNhZjU2MzVmOWJhZWZkYWI1Y2JmMTkwNzM5OGU4IiwgImdfaSI6ICJhZWNnYXV3Y200YWFhYXAzIiwgInQiOiAxfSAg&cv=c3.15.0"
//	rt, _ := client.Get(un, nil)
//
//	l := rt.Headers["Location"]
//	r2, _ := client.Get(l, nil)
//
//	fmt.Println(rt.Headers)
//	c := r2.Headers["Set-Cookie"]
//	fmt.Println(c)
//
