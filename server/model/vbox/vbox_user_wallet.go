...
type VboxUserWallet struct {
	...
	Recharge   int64      `json:"recharge" form:"recharge" gorm:"column:recharge;comment:积分余额;"`
	Tariff     float64    `json:"tariff" form:"tariff" gorm:"column:tariff;comment:费率;size:20;"`
