...
type VboxUserWallet struct {
      ...
      Recharge  *int `json:"recharge" form:"recharge" gorm:"column:recharge;comment:角色ID;size:10;"`
      ...
      VipLevel  *int `json:"vipLevel" form:"vipLevel" gorm:"column:vip_level;comment:会员等级;size:10;"`
