...
type ChannelAccount struct {
	...
	AcId       string `json:"acId" form:"acId" gorm:"column:ac_id;comment:账户ID;size:50;"`
	Cid        string `json:"cid" form:"cid" gorm:"column:cid;comment:通道id;size:10;"`
	Token      string `json:"token" form:"token" gorm:"column:token;comment:ck;size:256;type:text;"`
	DailyLimit uint   `json:"dailyLimit" form:"dailyLimit" gorm:"column:daily_limit;comment:日限额;size:10;"`
	TotalLimit uint   `json:"totalLimit" form:"totalLimit" gorm:"column:total_limit;comment:总限额;size:10;"`
	CountLimit uint   `json:"countLimit" form:"countLimit" gorm:"column:count_limit;comment:笔数限制;size:10;"`
