...
type RltnWidePayOrderD struct {
	...
	ChannelCode string     `json:"channelCode" form:"channelCode" gorm:"column:channel_code;comment:通道编码;size:32;"`
	ProductId   string     `json:"productId" form:"productId" gorm:"column:product_id;comment:产品ID;size:128;"`       //产品ID
	ProductName string     `json:"productName" form:"productName" gorm:"column:product_name;comment:产品名称;size:128;"` //产品名称                                 //通道编码
	...
	PAccount    string     `json:"pAccount" form:"pAccount" gorm:"column:p_account;comment:付方ID;size:64;"`
	PRemark     string     `json:"pRemark" form:"pRemark" gorm:"column:p_remark;comment:付方备注;size:64;"`                                              //付方备注                                          //付方ID
	...
	CbTime      *time.Time `json:"cbTime" form:"cbTime" gorm:"column:cb_time;comment:回调时间;index;"`
	Nickname    string     `json:"nickname" gorm:"comment:用户昵称"` // 用户昵称
	OrgID       uint       `json:"orgID" form:"orgID" gorm:"column:org_id;comment:团队id;"`
	OrgName     string     `json:"orgName" form:"orgName" gorm:"column:org_name;comment:团队名;"`
	OrgParentID uint       `json:"orgParentID" form:"orgParentID" gorm:"column:org_parent_id;comment:父节点ID;"` //回调时间                              //成交金额
	Dt          string     `json:"dt" form:"dt" gorm:"column:dt;comment:天;size:32;"`
...
func (RltnWidePayOrderD) TableName() string {
	return "vbox_rltn_wide_pay_order_d"
}
