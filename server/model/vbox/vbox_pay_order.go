...
type VboxPayOrder struct {
	...
	//AcAccount      string     `json:"ac_account" form:"ac_account" gorm:"column:ac_account;comment:账号名称;"`
	//AcRemark       string     `json:"ac_remark" form:"ac_remark" gorm:"column:ac_remark;comment:账号备注;"`
	CChannelId     string     `json:"c_channel_id" form:"c_channel_id" gorm:"column:c_channel_id;comment:通道编码;size:50;"`
