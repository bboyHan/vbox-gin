...
type ChannelGuideImg struct {
	global.GVA_MODEL
	ChannelId  string `json:"c_channel_id" form:"c_channel_id" gorm:"column:c_channel_id;comment:用户id;size:50;"`
	ImgBaseStr string `json:"img_base_str" form:"img_base_str" gorm:"column:img_base_str;comment:通道ID;size:500;"`
