...
func (s *VboxPayOrderRouter) InitVboxPayOrderRouter(Router *gin.RouterGroup) {
	...
	}
	{
		...
		vpoRouterWithoutRecord.GET("getHomePagePayOrderAnalysis", vpoApi.GetHomePagePayOrderAnalysis)                                   // 获取用户订单看板
		vpoRouterWithoutRecord.GET("getSelectUserPayOrderAnalysisH", vpoApi.GetSelectUserPayOrderAnalysisH)                             // 获取用户订单看板
