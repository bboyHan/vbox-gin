...
func (s *AuthorityRouter) InitAuthorityRouter(Router *gin.RouterGroup) {
	...
	}
	{
		...
		authorityRouterWithoutRecord.POST("getOwnerAuthorityList", authorityApi.GetOwnerAuthorityList)                                   // 获取角色列表
		authorityRouterWithoutRecord.POST("getOwnerAuthorityInfoListNoContainSelf", authorityApi.GetOwnerAuthorityInfoListNoContainSelf) // 获取角色列表
	}
}
